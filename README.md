...
PomidorQA - учебный веб-сервис для QA/IT-специалистов, предназначенный для коротких 25-минутных встреч между специалистами. Пользователь может указать свои навыки и темы, которые хочет изучить, найти подходящего участника и забронировать свободный слот. Сервис включает регистрацию, авторизацию, профили пользователей, управление навыками и слотами, поиск участников и бронирование встреч
